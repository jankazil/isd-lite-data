...
2. Loads station metadata from a text file previously generated by
   Switzerland_Metadata_Download.py.
3. Loads observations for the specified year range from gzipped ISD-Lite files
   previously downloaded using Switzerland_Observations_Download.py.
...
Inputs:
    - A station metadata text file named:
        switzerland_stations.<start_year>-<end_year>.txt
...
Example:
    Run this script after executing Switzerland_Metadata_Download.py and
    Switzerland_Observations_Download.py for the desired date range. The resulting
...
#
# Load metadata from local file (must have been previously downloaded using Switzerland_Metadata_Download.py)
#
...
#
# Load observations from local files (must have been previously downloaded using Switzerland_Observations_Download.py)
#
