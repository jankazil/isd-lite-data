...
3. Filters the stations by:
   - Country (only U.S. stations are retained).
   - Geographic coordinates (restricted to the CONUS region).
...
Example:
    python CONUS_Metadata_Download.py 2020 1 1 2020 12 31 ./output_data
'''
...
conus_stations.save(
    'Stations in the contiguous US with observations '
    + str(start_date.year)
    + ' - '
    + str(end_date.year),
    file_path,
