...
def arg_parse(argv=None):
    ...
    parser.add_argument('data_dir',type=str,help='Directory path into which the data will be downloaded. Must contain station metadata file downloaded previously with CONUS_Metadata_Download.py.',)
