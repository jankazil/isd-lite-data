...
files produced by Switzerland_Metadata_Download.py.
...
Example:
    python Switzerland_Observations_Download.py 2020 1 1 2020 12 31 ./output_data -n 4
'''
...
assert file_path.is_file(), 'Metadata file not available at : ' + str(file_path) + '. Use Switzerland_Metadata_Download.py to download it.'
