...
def download_stations(local_dir: Path,refresh: bool = False) -> Path:
    
    """
    
    Downloads the file holds station information (station IDs, locations, ...),
    unless it already exists locally.
    
    Args:
        local_dir (Path): Local directory where the downloaded file will be saved.
        refresh (bool, optional): If True, download even if the file already exists. Defaults to False.
